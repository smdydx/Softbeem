...
export default function GSTNilReturn() {
    ...
    <main className="min-h-screen bg-gradient-to-b from-zinc-900 via-zinc-900 to-black pt-24 text-white">
      ...
      <section className="py-12 bg-zinc-900/30">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold text-green-400 mb-4">GST NIL Return Filing</h2>
          <p className="text-gray-300 mb-4">
            A GST NIL Return is filed when there are no outward supplies, inward supplies, or tax liability during a tax period. Filing is still mandatory even if there’s no business activity. Ramaera helps ensure timely NIL filings to avoid penalties.
          </p>
          <ul className="list-disc list-inside text-gray-300 space-y-1">
            <li>Quick NIL GSTR-1 & GSTR-3B filing every month or quarter</li>
            <li>Due date reminders</li>
            <li>Avoid late fees and interest</li>
            <li>Assistance in zero transaction reporting</li>
          </ul>
        </div>
      </section>
