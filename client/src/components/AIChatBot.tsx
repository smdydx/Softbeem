      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[6rem] right-4 sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 w-[calc(100vw-2rem)] max-w-sm sm:max-w-md md:max-w-lg h-[55vh] sm:h-[65vh] md:h-[80vh] max-h-[500px] bg-gradient-to-b from-zinc-900/98 via-zinc-900/95 to-black/98 backdrop-blur-2xl rounded-3xl border border-green-500/30 shadow-2xl shadow-green-500/20 overflow-hidden z-[70]"
          >
