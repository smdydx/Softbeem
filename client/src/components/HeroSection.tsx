...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 relative z-10 mt-8 sm:mt-12 md:mt-16 lg:mt-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center">
          ...
          >
            <h1
              className="font-bold tracking-wider bg-clip-text text-transparent digital-glow relative z-10 hover:scale-105 transition-transform duration-300 flex flex-col sm:flex-row items-center gap-2 sm:gap-4 mb-4 sm:mb-6 justify-center lg:justify-start text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl"
              style={{
            ...
            >
              ...
              <span className="mt-2 sm:mt-0">{settings.companyName || "Softbeem"}</span>
            </h1>

            <div className="flex flex-col sm:flex-row flex-wrap gap-1 sm:gap-3 items-center justify-center lg:justify-start mb-4 sm:mb-6">
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-4 sm:mb-6 lg:mb-8 max-w-lg mx-auto lg:mx-0 px-2 sm:px-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start px-2 sm:px-0">
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className="bg-gradient-to-r from-[#00FF00] to-[#004400] hover:from-[#008000] hover:to-[#006600] text-white border-none shadow-lg shadow-green-500/20 transition-all duration-300 hover:scale-105 w-full sm:w-auto text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3"
                  >
                    <span className="text-xs sm:text-sm">Explore Our Services</span>
                    <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 ml-1 sm:ml-2" />
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-80 sm:w-72 p-3 backdrop-blur-xl bg-black/80 border border-green-500/20 mx-2 sm:mx-0">
              ...
              <Button
                ...
                className="border-green-500/30 text-white hover:bg-green-500/10 shadow-lg w-full sm:w-auto text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3"
              >
                Contact Us
              </Button>
            </div>
          ...
          <motion.div
            ...
            className="flex flex-col justify-center items-center mt-4 sm:mt-6 lg:mt-8 order-1 lg:order-2"
          >
            <div className="mt-2 sm:mt-4 md:mt-8 lg:mt-16 xl:mt-40">
              {globeLoaded ? (
                <JarvisGlobe size={isMobile ? 250 : 400} />
              ) : (
                <div 
                ...
                >
                  <div className="w-6 h-6 sm:w-8 sm:h-8 border-2 border-green-500 border-t-transparent rounded-full animate-spin"></div>
                </div>
              )}
            </div>
            <div className="mt-3 sm:mt-4 md:mt-6 lg:mt-8 xl:mt-16">
              <ServiceIcons />
            </div>
          </motion.div>
        </div>
