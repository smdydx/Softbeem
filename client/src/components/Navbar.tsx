        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 sm:gap-4 p-3 sm:p-4 border-b border-green-500/10">
              <a 
                href="tel:+911169310715" 
                className="flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-400 transition-all border border-green-500/30 min-w-[44px] min-h-[44px]"
              >
              ...
              <button 
                onClick={() => window.location.href = '/schedule'} 
                className="flex items-center justify-center w-11 h-11 sm:w-14 sm:h-12 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-400 transition-all border border-green-500/30 min-w-[44px] min-h-[44px]"
              >
