        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 p-4 border-b border-green-500/10 bg-zinc-900/50">
              <a
                href="tel:+911169310715"
                className="flex items-center justify-center w-14 h-14 rounded-md bg-green-500/10 hover:bg-green-500/20 text-green-400 transition-all border border-green-500/30"
              >
