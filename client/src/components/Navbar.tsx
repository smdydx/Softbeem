        ...
        <div className="flex items-center justify-between bg-gradient-to-r from-zinc-900/50 via-transparent to-zinc-900/50 rounded-full px-3 sm:px-4 lg:px-6 py-2 backdrop-blur-sm border border-green-500/10">
          ...
          <nav className="hidden md:flex items-center justify-center flex-1 space-x-2 lg:space-x-4 xl:space-x-8">
            {navLinks.map((link, index) => {
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="relative text-white hover:text-primary font-semibold text-lg transition-colors duration-300 group flex items-center gap-1"
                    >
                      {link.name}
                      <ChevronDown
              ...
              // About Us - simple link without submenu
              if (link.name === "About Us") {
                return (
                  <div key={index} className="flex items-center gap-16">
                    <button
                      onClick={() => scrollToSection(link.href)}
                      className="relative text-white hover:text-primary font-semibold text-lg transition-colors duration-300 group"
                    >
                      {link.name}
                      <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
                    </button>
              ...
              {navLinks.map((link, index) => {
                  ...
                  return (
                    <div key={index} className="border-b border-green-500/10">
                      <button
                        ...
                        className="flex items-center justify-between gap-3 w-full text-left px-4 py-3 text-white hover:text-primary hover:bg-zinc-800/50 rounded-lg transition-all duration-300 border border-transparent hover:border-primary/20 font-semibold text-lg"
                      >
                        <span>{link.name}</span>
                        <ChevronDown
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-3 w-full text-left px-4 py-3 text-white hover:text-primary hover:bg-zinc-800/50 rounded-lg transition-all duration-300 border border-transparent hover:border-primary/20 font-semibold text-lg"
                  >
                    {link.name}
                  </button>
                );
